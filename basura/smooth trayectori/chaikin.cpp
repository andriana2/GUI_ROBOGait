...
int main()
{
    ...
    std::vector<Punto> puntosReducidos2 = reducirPuntosAdaptativo(puntosOriginales, 2.0);
    std::vector<Punto> puntosDouglas2;
    DouglasPeucker(puntosOriginales, 1.5, puntosDouglas2);
    std::vector<Punto> puntosFiltrados2 = filtroMedianaMovil(puntosOriginales, 3);
    std::vector<Punto> puntosSinDuplicados2 = eliminarDuplicados(puntosOriginales);

    int iteraciones = 6;
     std::vector<Punto> puntosReducidos = suavizarTrayectoriaChaikin(puntosReducidos2, iteraciones);
    std::vector<Punto> puntosDouglas = suavizarTrayectoriaChaikin(puntosDouglas2, iteraciones);
    std::vector<Punto> puntosFiltrados = suavizarTrayectoriaChaikin(puntosFiltrados2, iteraciones);
    std::vector<Punto> puntosSinDuplicados = suavizarTrayectoriaChaikin(puntosSinDuplicados2, iteraciones);
