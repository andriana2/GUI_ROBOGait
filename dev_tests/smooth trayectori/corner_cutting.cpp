...
int main()
{
    ...
    float alpha = 0.25; // Ajusta qué tan agresivo es el corte
     ...
     std::vector<Punto> puntosFiltrados = suavizarTrayectoriaCornerCutting(puntosReducidos3, iteraciones, alpha);
    std::vector<Punto> puntosDouglas = suavizarTrayectoriaCornerCutting(puntosDouglas2, iteraciones, alpha);
    std::vector<Punto> puntosSinDuplicados = suavizarTrayectoriaCornerCutting(puntosDouglas3, iteraciones, alpha);
